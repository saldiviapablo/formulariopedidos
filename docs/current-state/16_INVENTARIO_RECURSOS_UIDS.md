...
| Nombre de Página | Path | UID Página |
|---|---|---|
| Home / Formulario | `/` | `50ee979b-2ff9-4235-8ea5-6ce664539886` |
| Solicitud Recibida | `/solicitud-recibida` | `7ee2bf10-5390-4e3a-b5e1-cf2489c9faee` |
| Seguimiento Público | `/seguimiento` | `99434d02-40ae-432d-8b01-ffaa107b5a8e` |
| Responder Información | `/solicitud-informacion` | `6c8fe77a-ec4f-40e1-ad26-7876a44ca70a` |
| Login | `/login` | `10cf599d-1dc8-4444-bca5-b3844fdf5ae9` |
| Solicitar Acceso | `/solicitar-acceso` | `a563fbb9-25f0-466d-a19e-f008892419db` |
| Bandeja de Gestión | `/gestion` | `a39854ef-f0ad-448f-aa1c-0e9e4a3b7080` |
| Detalle de Pedido | `/pedido/:id` | `48ba972e-d09f-4318-971c-3220fe4ae4ef` |
| Administración Usuarios | `/usuarios` | `7982e5ff-7e47-49d7-8c43-8ce8325ef01b` |
| Error 404 | `/404` | `40404040-4040-4040-4040-404040404040` |

---

## 2. Backend Workflows (17 Workflows)

| Nombre de Backend Workflow | UID Backend Workflow |
|---|---|
...
|---|---|---|
| `N8N_PEDIDOS_JWT_SECRET_V2` | Secret | Firma HS256 de webhooks hacia n8n |
| `N8N_WEBHOOK_URL_PEDIDOS` | String | Endpoint URL de recepción de pedidos en n8n |
| `RESEND_API_KEY` | Secret | Credencial de despacho de emails transaccionales |
| `NOTION_API_KEY` | Secret | Integración de sincronización con base de Notion |
| `NOTION_DATABASE_ID` | String | ID de la base de datos de pedidos en Notion |
| `APP_PUBLIC_URL` | String | Base URL (`https://secretariamedios-production.weweb.io`) |

---

## 4. Evidencia de Verificación
- `[WEWEB-VERIFICADO]`: UIDs y variables recolectados de los endpoints y stores oficiales de WeWeb.
